...
class _ProductsPageState extends State<ProductsPage> {
  ...
  void _initializeProducts() {
    _allProducts = [
      ...
      Product(
        ...
        sku: 'NIKE270',
        details: 'Men\'s running, black/white, lightweight',
        mrp: 12999.00,
      ...
      Product(
        ...
        name: 'Samsung 4K TV',
        sku: 'SAMTV55',
        details: '55-inch Smart LED TV with HDR support',
        mrp: 49999.00,
        discountPercentage: 24,
        imageAsset: 'https://picsum.photos/id/10/100/100',
      ),
      Product(
        no: 3,
        name: 'Esha Cotton Shirt',
        sku: 'ESHSHIRT',
        details: 'Blue, size M, 100% breathable cotton fabric',
        mrp: 1499.00,
        discountPercentage: 10,
        imageAsset: 'https://picsum.photos/id/100/100/100',
      ),
      Product(
        no: 4,
        name: 'Esha Leather Wallet',
        sku: 'ESHWALLET',
        details: 'Genuine brown leather wallet with multiple card slots',
        mrp: 599.00,
        discountPercentage: 27,
        imageAsset: 'https://picsum.photos/id/1000/100/100',
      ),
      Product(
        no: 5,
        name: 'HP Spectre x360',
        sku: 'HPSPECTRE',
        details: '13.3" 2-in-1 Laptop, i7 processor, 16GB RAM',
        mrp: 99999.00,
        discountPercentage: 15,
        imageAsset: 'https://picsum.photos/id/1002/100/100',
      ),
      Product(
        no: 6,
        ...
        sku: 'SONY1000',
        details:
            'Industry-leading noise cancelling headphones with premium sound',
        mrp: 29999.00,
        discountPercentage: 20,
        imageAsset: 'https://picsum.photos/id/1003/100/100',
      ),
      Product(
        no: 7,
        name: 'Instant Pot Duo',
        sku: 'INSTPOT6',
        details: '7-in-1 Electric Pressure Cooker, 6 Quart',
        mrp: 7999.00,
        discountPercentage: 18,
        imageAsset: 'https://picsum.photos/id/1004/100/100',
      ),
      Product(
        no: 8,
        name: 'Kindle Paperwhite',
        sku: 'KINDLEPW',
        details: 'Waterproof E-reader with a built-in adjustable light',
        mrp: 10999.00,
        discountPercentage: 12,
        imageAsset: 'https://picsum.photos/id/1005/100/100',
      ),
      Product(
        no: 9,
        name: 'Logitech MX Master 3',
        sku: 'LOGIMX3',
        details: 'Advanced Wireless Mouse with MagSpeed scrolling',
        mrp: 9999.00,
        discountPercentage: 8,
        imageAsset: 'https://picsum.photos/id/1006/100/100',
      ),
      Product(
        no: 10,
        name: 'Google Nest Hub',
        sku: 'NESTHUB',
        details: 'Smart Display with Google Assistant and 7" screen',
        mrp: 6999.00,
        discountPercentage: 14,
        imageAsset: 'https://picsum.photos/id/1008/100/100',
      ),
      Product(
        no: 11,
        name: 'Apple Watch Series 7',
        sku: 'AWATCH7',
        details: 'GPS + Cellular, Aluminium Case, Midnight color',
        mrp: 41900.00,
        discountPercentage: 10,
        imageAsset: 'https://picsum.photos/id/101/100/100',
      ),
      Product(
        no: 12,
        name: 'Dyson V11 Absolute',
        sku: 'DYSV11',
        details: 'Cordless Vacuum Cleaner with powerful suction',
        mrp: 52900.00,
        discountPercentage: 15,
        imageAsset: 'https://picsum.photos/id/1011/100/100',
      ),
      Product(
        no: 13,
        name: 'Bose QuietComfort Earbuds',
        sku: 'BOSECQ',
        details: 'Noise Cancelling, True Wireless with secure fit',
        mrp: 26900.00,
        discountPercentage: 18,
        imageAsset: 'https://picsum.photos/id/1012/100/100',
      ),
      Product(
        no: 14,
        name: 'GoPro HERO10 Black',
        sku: 'GOPRO10',
        details: 'Waterproof Action Camera with 5.3K video',
        mrp: 44900.00,
        discountPercentage: 22,
        imageAsset: 'https://picsum.photos/id/1013/100/100',
      ),
      Product(
        no: 15,
        name: 'Nintendo Switch OLED',
        sku: 'NINTDOLED',
        details: '7-inch OLED Screen, brighter colors, enhanced audio',
        mrp: 34900.00,
        discountPercentage: 5,
        imageAsset: 'https://picsum.photos/id/1014/100/100',
      ),
      Product(
        no: 16,
        name: 'Fitbit Charge 5',
        sku: 'FITBITC5',
        details: 'Advanced Fitness Tracker with EDA Sensor',
        mrp: 14900.00,
        discountPercentage: 20,
        imageAsset: 'https://picsum.photos/id/1015/100/100',
      ),
      Product(
        no: 17,
        ...
        imageAsset: 'https://picsum.photos/id/1016/100/100',
      ),
      Product(
        no: 18,
        name: 'Razer DeathAdder V2',
        sku: 'RAZERDV2',
        details: 'Ergonomic Gaming Mouse, 20K DPI optical sensor',
        mrp: 5999.00,
        discountPercentage: 10,
        imageAsset: 'https://picsum.photos/id/1018/100/100',
      ),
      Product(
        no: 19,
        name: 'Philips Hue Starter Kit',
        sku: 'PHILHUE',
        details: 'Smart Lighting, White & Color Ambiance',
        mrp: 8999.00,
        discountPercentage: 12,
        imageAsset: 'https://picsum.photos/id/1019/100/100',
      ),
      Product(
        no: 20,
        name: 'Sony PlayStation 5',
        sku: 'PS5DISK',
        details: 'Disc Edition Console, next-gen gaming experience',
        mrp: 49990.00,
        discountPercentage: 0,
        imageAsset: 'https://picsum.photos/id/102/100/100',
      ),
    ];
  }
  ...
  List<Product> get _productsToShow {
    ...
    return _filteredProducts.sublist(
      start.clamp(0, _filteredProducts.length),
      end,
    );
  }
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: product.discountPercentage > 20
                    ? Colors.green[50]
                    : Colors.orange[50],
  ...
  Widget _buildPagination() {
    final start = ((_currentPage - 1) * _itemsPerPage + 1).clamp(
      1,
          ...
          Row(
            children: [
              IconButton(
                ...
                icon: Icon(
                  Icons.chevron_left,
                  color: _currentPage > 1 ? Colors.indigo : Colors.grey,
                ),
              ),
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              if (name.isEmpty ||
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text('All fields required except SKU'),
                  ),
                );
                return;
              }
              ...
              final newProduct = Product(
                ...
                sku: sku.isNotEmpty
                    ...
                    : name
                          ...
                          .join(), // Use custom SKU or generate
                details: details,
                mrp: mrp,
        ...
        actions: [
          ...
          ElevatedButton(
            style: ElevatedButton.styleFrom(
              backgroundColor: Colors.indigo,
              foregroundColor: Colors.white,
            ), // Added foregroundColor here too
            onPressed: () {
              final name = nameCtrl.text.trim();
